...
import { CallExpression, NameExpression, OperatorExpression } from '../pratt-parser-base';
...
function expectResult<T>(formula: string, expectedResult: T, expressionClass: unknown) {
...
function expectResults(name: string, testValues: [string, unknown][], expressionClass: unknown) {
  describe(name, () => {
