/** Maps each non-internal field type to a human-readable description of what the type means. */
...
/** Maps each internal field type to a human-readable description of what the type means. */
...
/** Maps each field type to a human-readable description of what the type means. */
